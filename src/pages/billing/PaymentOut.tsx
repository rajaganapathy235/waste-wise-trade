...
export default function PaymentOut() {
  ...
  const handleSave = () => {
    ...
    const payment: Payment = {
      id: Date.now().toString(), type: "out", partyId, partyName: selectedParty?.name || "",
  ...
  return (
    <div className="px-4 pt-3 pb-8 max-w-lg mx-auto">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h1 className="text-lg font-bold">Record Payment Out</h1>
      </div>

      <div className="bg-destructive/10 rounded-lg p-3 mb-4">
        <p className="text-xs text-destructive font-semibold">Payment Out #{(Math.floor(Math.random() * 99) + 1)}</p>
